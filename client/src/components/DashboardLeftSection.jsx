...
function DashboardLeftSection() {
  return (
    <div className="h-full py-11 flex flex-col bg-lightOverlay backdrop-blur-md shadow-md min-w-[210px] w-[180px]  xl:min-w-210 lg:min-w-[180px] lg:w-[200px] xl:w-300  gap-3">
